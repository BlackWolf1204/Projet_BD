<!-- Connexion.php --> 
<!--Notes 23/11/2022 : Problemen avec l'affichage de l'image de validation, il faut que je trouve une solution pour l'afficher au premier plan, apresc'est que en option)-->
...
// On se connecte à la base de données interne qui se trouve dans le dossier 
...

{
    ...
    {
        $requser = $bdd->prepare("SELECT * FROM info_comptes WHERE Mail = ? AND MotDePasse = ?");
        ...
        if($userexist == 1)
        {
            ...
            //Pour tester la page gestion_compte.php
            header("Location: gestion_compte.php?id=".$_SESSION['Id']);
            ...
            <div class="container mt-5"> <!-- container c'est pour le centrage -->
                ...
                <div class="col-sm-8 offset-sm-2"><!-- col-sm-8 offset-sm-2 c'est pour le centrage avec un espace de 2 -->
                    ...
                    <div class="form-row"><!-- Div pour connecter avec le mail et le mot de passe -->
                        ...
                        <div class="form-group col-md-6">
                            <input type="password" name="Mot_de_passe_Connexion" class="form-control" placeholder="Mot de passe" required, value="<?php if(isset($mdpconnect)) { echo $mdpconnect; } ?>">
                       </div>
